...
- [ESPHome Bluetooth Proxy](esphome/bluetooth-proxy.yaml) (více v článku [Bluetooth zařízení a ESPHome proxy](https://blog.vyoralek.cz/iot/homeassistant-24-bluetooth-zarizeni-a-esphome-proxy/))
